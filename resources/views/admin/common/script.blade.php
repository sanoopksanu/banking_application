{{--
  ...
  <script src="{{asset('assets/admin/vendors/php-email-form/validate.js')}}"></script>
  <script src="{{asset('assets/admin/vendors/waypoints/jquery.waypoints.min.js')}}"></script>
  <script src="{{asset('assets/admin/vendors/counterup/counterup.min.js')}}"></script>
  <script src="{{asset('assets/admin/vendors/isotope-layout/isotope.pkgd.min.js')}}"></script>
  <script src="{{asset('assets/admin/vendors/venobox/venobox.min.js')}}"></script>
  <script src="{{asset('assets/admin/vendors/owl.carousel/owl.carousel.min.js')}}"></script>
